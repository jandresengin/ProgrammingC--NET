...
namespace Assignment05
{
    ...
    public partial class frmLibraryMovies : Form
    {
        ...
        {//function that checks if the user entered movies in another form, if it is greater than or equal to 1, it will proceed to operate as if the user entered them manually.
            int numberOfLateMoviesForm = Decimal.ToInt32(frmLateFilms.numberMoviesByType["LibraryMovie"]);
            numberOfDays = (double)frmLateFilms.numberDaysMoviesByType["LibraryMovie"];
